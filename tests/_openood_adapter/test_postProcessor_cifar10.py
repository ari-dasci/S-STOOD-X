...
@pytest.mark.parametrize("quantile", [0.0, 0.125, 0.25, 0.375, 0.5, 0.625, 0.75, 0.875])
...
def test_Baseline_cifar10_postProcessor(id_set, model_name, weights, fsood, baseline_postprocessor):
