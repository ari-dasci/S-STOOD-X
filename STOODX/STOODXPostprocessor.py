...
class STOODXPostprocessor(BasePostprocessor):
    def __init__(self, config):
        ...
        self.quantil = self.config['quantil']
    ...
    def setup(self, net: torch.nn.Module, id_loader_dict, ood_loader_dict):
        ...
        feature_estractor = FeatureEstractor(model = net, device=self.device, feature_name=self.feature_name,atribut=self.atribut).to(self.device)
        self.oodTest = STOODX(
